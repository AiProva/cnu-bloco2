...
export const metadata: Metadata = {
  title: "AiProva! - Bloco 2 (CNU) - Acelere sua Aprovação",
  description:
    "Estude com mais de 5.000 flashcards prontos focados no Bloco 2 do Concurso Nacional Unificado e acelere a sua aprovação.",
    generator: 'v0.dev'
}
